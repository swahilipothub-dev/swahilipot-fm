  ...
  return (
    ...
    >
      <a
        ...
        className='group flex max-w-full cursor-pointer flex-col items-center gap-3.5 rounded-2xl border border-gray-100 bg-gray-50/50 px-10 py-8 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-gray-200 hover:bg-white hover:shadow-lg hover:shadow-gray-900/[0.06] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#271d73]/30 focus-visible:ring-offset-2 md:px-14'
      >
        {/* Brand plate keeps the white logo artwork visible on the light page */}
        <span className='inline-flex items-center rounded-xl bg-[#e98523] px-5 py-3 transition-transform duration-300 ease-out group-hover:scale-[1.02]'>
          <img
            src={publisher.logo}
